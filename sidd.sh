...
1. Run npm test. If it is red, fix it, without weakening or deleting tests, commit "fix: gate green" and stop. Make sure tests always stay green before you leave. If it is green, continue to step 2.
...
If the plan itself is wrong, do not work around it: note why in AGENT_NOTES.md, leave the box unchecked, commit, stop.
